package ru.tyshchenko.vkr.engine.impl.java.service;
...
public class ServiceSpringFactory implements ServiceFactory {
    ...
    public Map<String, String> buildServices(List<ServiceInfo> serviceInfos, Map<String, EntityDtoInfo> entityDtoInfoMap) {
        ...
        for (var serviceInfo : serviceInfos) {
            ...
            replaceByRegex(serviceBuilder, DefaultPlaceholder.CLASS_NAME, toUpperCaseFirstLetter(toCamelCase(serviceInfo.getName())));
            ...
            replaceByRegex(serviceBuilder, DefaultPlaceholder.FIELDS, fields);
            ...
            replaceByRegex(serviceBuilder, DefaultPlaceholder.METHODS, methodsBuilder.toString());
            replaceByRegex(serviceBuilder, DefaultPlaceholder.IMPORTS, buildImports(imports));
    ...
    public String language() {
        return SupportedServiceLanguage.JAVA_SPRING.name();
    }
